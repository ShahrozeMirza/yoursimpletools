...
<main>
  <div class="tool-page">
    <div class="container">
      ...
      <div style="background: #EFF6FF; border: 1px solid #3B82F6; border-radius: 8px; padding: 12px 16px; display: flex; align-items: flex-start; gap: 10px; margin-bottom: 24px; font-size: 14px; color: #161616;">
      ...
      <!-- Business / Sender Details + Bill To / Client Details -->
      ...
      <!-- Totals -->
      <div class="tool-container mt-24">
        <div style="max-width: 360px; margin-left: auto; margin-top: 24px;">
